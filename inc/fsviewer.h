...
#define FSVIEWER_FATFS 2
#define SVIEWER_STDIO 1

#include "makise_config.h"

#if defined(ELEMENT_FSVIEWER_FATFS_ENABLED) || defined(ELEMENT_FSVIEWER_STDIO_ENABLED)
...
#include "makise_e.h"
#ifdef ELEMENT_FSVIEWER_FATFS_ENABLED
//FATFS
#include "ffconf.h"
#include "ff.h"
#else //STDIO
